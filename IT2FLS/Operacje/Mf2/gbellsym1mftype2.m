function [dolna, gorna] = gbellsym1mftype2(x,parametry)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%gbellsym1type2
%   Funkcja generuj¹ca doln¹ i gorna funkcje przynaleznosci typu gbell
%   
%     Argumenty:
%     x - wektor wartosci x
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [dolna, gorna] = ewaluacjamf2(x,parametry,'gbellsym1mftype2');
