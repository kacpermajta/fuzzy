function [dolna, gorna] = sigmftype2(x,parametry)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%sigmftype2
%   Funkcja generuj¹ca doln¹ i gorna funkcje przynaleznosci typu sigma
%   
%     Argumenty:
%     x - wektor wartosci x
...
%     
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    [dolna, gorna] = ewaluacjamf2(x,parametry,'smftype2');
