function varargout = Pod_reg_back(varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Pod_reg_back
...
%     
%     Uwagi:
%     Plik/funkcja mocno powiazana z plikiem Pod_reg_back.fig - w nim zapisana jest 
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @Pod_reg_back_OpeningFcn, ...
                   'gui_OutputFcn',  @Pod_reg_back_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Pod_reg_back is made visible.
function Pod_reg_back_OpeningFcn(hObject, eventdata, handles, varargin)
...
% UIWAIT makes Pod_reg_back wait for user response (see UIRESUME)
% uiwait(handles.pod);
...
function varargout = Pod_reg_back_OutputFcn(hObject, eventdata, handles) 
