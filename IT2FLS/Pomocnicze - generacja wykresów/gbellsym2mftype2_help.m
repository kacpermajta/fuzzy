x = 0:0.1:10;
[dolna, gorna]=gbellsym2mftype2(x,[1 1.5 2.5 5]);
figure;
...
text('Position',[4.3,0.55],'String','a','fontsize',18)
line([5 5+1.5],[0.5 0.5],'color','r','linewidth',2,'linestyle','--')
text('Position',[5.1,0.55],'String','a_2','fontsize',18)
xlabel('x','FontSize',18); ylabel('\mu(x)','FontSize',18); grid on
title('\mu(x) = gbellsym2mftype2(x,[a_1 a_2 b c])','FontSize',18)