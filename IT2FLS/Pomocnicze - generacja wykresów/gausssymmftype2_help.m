x = 0:0.1:10;
[dolna, gorna]=gausssymmftype2(x,[1 4 6]);
figure;
...
line([6 6+1],[0.6 0.6],'color','b','linewidth',2,'linestyle','--')
text('Position',[6.0,0.65],'String','\sigma_1','fontsize',18)
xlabel('x','FontSize',18); ylabel('\mu(x)','FontSize',18); grid on
title('\mu(x) = gausssymmftype2(x,[\sigma_1 m_1 m_2])','FontSize',18)