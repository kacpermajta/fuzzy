...
%%%%%rysowanie po raz pierwszy
    ...
    %tworzenie okienek regul i zmiennych
        ...
        set(handles.wej3_wart,'Min',0,'Max',1);
        set(handles.wej4_wart,'Min',0,'Max',1);        
        
        %ustawienie disable sliderow i napisow
        if IleWejsc == 1
            zakres1 = fls.input(1).range(1);            
            zakres2 = fls.input(1).range(2);
            set(handles.wej1_wart,'Min',zakres1,'Max',zakres2);            
        ...
        elseif IleWejsc == 2 
            ...
            set(handles.wej2_wart,'Min',zakres1,'Max',zakres2);
            set(handles.wej1_wart,'Enable','On');
            set(handles.text_we1,'Enable','On');
        ...
        elseif IleWejsc == 3
            ...
            set(handles.wej3_wart,'Min',zakres1,'Max',zakres2);   
            ...
            set(handles.wej4_wart,'Min',zakres1,'Max',zakres2); 
            %ustawienie enable siderow
            set(handles.wej1_wart,'Enable','On');
            set(handles.text_we1,'Enable','On');
            set(handles.wej2_wart,'Enable','On');
...
%                 %Obliczenia fls2
                       ...
                       for  k=1:IleWyjsc 
                        if Conn == 1
                            ...
                            if IleWejsc == 1
                                min_dolna = min(mf_dolna(:,1));
                                min_gorna = min(mf_gorna(:,1));

                                [X_ob(k,:), Y_ob(k,:)] = and_plot_bs(x, min_dolna, min_gorna,mf_dolna_wyj(k,:),mf_gorna_wyj(k,:)); 
                            elseif IleWejsc == 2
                                [min_dolna, min_gorna] = min_and(n_lin1x,n_lin2x,mf_dolna(:,1),mf_gorna(:,1),mf_dolna(:,2),mf_gorna(:,2));
                                    if min_dolna > min_gorna
                                        temp = min_dolna;
                                        min_dolna = min_gorna;
                                        min_gorna = temp;
                            ...
                            elseif IleWejsc == 3  
                                ...
                                [min_dolna2, min_gorna2] = min_and(n_lin1x,n_lin3x,mf_dolna(:,1),mf_gorna(:,1),mf_dolna(:,3),mf_gorna(:,3));
                                    ...
                                    min_dolna = min([min_dolna1 min_dolna2]);
                                    min_gorna = min([min_gorna1 min_gorna2]);
                                [X_ob(k,:), Y_ob(k,:)] = and_plot_bs(x, min_dolna, min_gorna,mf_dolna_wyj(k,:),mf_gorna_wyj(k,:));                            
                            elseif IleWejsc == 4
                                [min_dolna1, min_gorna1] = min_and(n_lin1x,n_lin2x,mf_dolna(:,1),mf_gorna(:,1),mf_dolna(:,2),mf_gorna(:,2));
                                    if min_dolna1 > min_gorna1
                                ...
                                [min_dolna2, min_gorna2] = min_and(n_lin3x,n_lin2x,mf_dolna(:,3),mf_gorna(:,3),mf_dolna(:,4),mf_gorna(:,4));
                                    if min_dolna2 > min_gorna2
                                        temp = min_dolna2;
                                        min_dolna2 = min_gorna2;
                                        min_gorna2 = temp;
                            ...
                            elseif strcmp(fls.andMethod,'prod')
                                if IleWejsc == 1
                                    prod_dolna = prod(mf_dolna(:,1));
                                    prod_gorna = prod(mf_gorna(:,1));
                                elseif IleWejsc == 2
                                    [prod_dolna, prod_gorna] =   prod_and(n_lin1x,n_lin2x,mf_dolna(:,1),mf_gorna(:,1),mf_dolna(:,2),mf_gorna(:,2));
                                    if prod_dolna > prod_gorna
                                            temp = prod_dolna;
                                            prod_dolna = prod_gorna;
                                            prod_gorna = temp;
                                    end
                                [X_ob(k,:), Y_ob(k,:)] = and_plot_bs(x, prod_dolna, prod_gorna,mf_dolna_wyj(k,:),mf_gorna_wyj(k,:));
                                elseif IleWejsc == 3
                                    ...
                                    prod_dolna = prod([prod_dolna1 prod_dolna2]);
                                    prod_gorna = prod([prod_gorna1 prod_gorna2]);
                                [X_ob(k,:), Y_ob(k,:)] = and_plot_bs(x, prod_dolna, prod_gorna,mf_dolna_wyj(k,:),mf_gorna_wyj(k,:));
                                elseif IleWejsc == 4
                                     [prod_dolna1, prod_gorna1] =   prod_and(n_lin1x,n_lin2x,mf_dolna(:,1),mf_gorna(:,1),mf_dolna(:,2),mf_gorna(:,2));
                                    if prod_dolna1 > prod_gorna1
                                    ...
                                    [prod_dolna2, prod_gorna2] =   prod_and(n_lin1x,n_lin2x,mf_dolna(:,3),mf_gorna(:,3),mf_dolna(:,4),mf_gorna(:,4));
                                    if prod_dolna2 > prod_gorna2
                                            temp = prod_dolna2;
                                            prod_dolna2 = prod_gorna2;
                                            prod_gorna2 = temp;
                            ...
                            X_ob2(k,:) = downsample(X_ob(k,:),8)
                            X_ob2(k,:) = X_ob2(k,:)*skok_x/100+krL+(skok_x+2)*(IleWejsc);
                            %wartosc obliczona * wspolczynik wysokosci +
                            %ilosc okien * skok w pionie
                            Y_ob2(k,:) = downsample(Y_ob(k,:),8);                           
                            Y_ob2(k,:) = Y_ob2(k,:)*(oknoWys+1)+oknoD-(i-1+k)*skok_y;
                        ...
                        %dla connection OR
                            ...
                            %warunek gdy sa 2 wejscia 1 wyjscie
                            if IleWejsc == 1
                                min_dolna = max(mf_dolna(:,1));
                                min_gorna = max(mf_gorna(:,1));

                                [X_ob(k,:), Y_ob(k,:)] = or_plot_bs(x, min_dolna, min_gorna,mf_dolna_wyj(k,:),mf_gorna_wyj(k,:)); 
                            elseif IleWejsc == 2
                                [min_dolna, min_gorna] = max_or(n_lin1x,n_lin2x,mf_dolna(:,1),mf_gorna(:,1),mf_dolna(:,2),mf_gorna(:,2));
                                    if min_dolna > min_gorna
                                        temp = min_dolna;
                                        min_dolna = min_gorna;
                                        min_gorna = temp;
                            ...
                            elseif IleWejsc == 3  
                                ...
                                [min_dolna2, min_gorna2] = max_or(n_lin1x,n_lin3x,mf_dolna(:,1),mf_gorna(:,1),mf_dolna(:,3),mf_gorna(:,3));
                                    if min_dolna2 > min_gorna2
                                        temp = min_dolna2;
                                        min_dolna2 = min_gorna2;
                                        min_gorna2 = temp;
                                    end                                
                                    min_dolna = max([min_dolna1 min_dolna2]);
                                    min_gorna = max([min_gorna1 min_gorna2]);
                                [X_ob(k,:), Y_ob(k,:)] = and_plot_bs(x, min_dolna, min_gorna,mf_dolna_wyj(k,:),mf_gorna_wyj(k,:));                            
                            elseif IleWejsc == 4
                                [min_dolna1, min_gorna1] = max_or(n_lin1x,n_lin2x,mf_dolna(:,1),mf_gorna(:,1),mf_dolna(:,2),mf_gorna(:,2));
                                    if min_dolna1 > min_gorna1
                                ...
                                [min_dolna2, min_gorna2] = max_or(n_lin3x,n_lin2x,mf_dolna(:,3),mf_gorna(:,3),mf_dolna(:,4),mf_gorna(:,4));
                                    if min_dolna2 > min_gorna2
                                        temp = min_dolna2;
                                        min_dolna2 = min_gorna2;
                                        min_gorna2 = temp;
                            ...
                            %wpisanie do macierzy wynikow przed skalowaniem
                                ...
                                Y_ob2(k,:) = downsample(Y_ob(k,:),8);
                                Y_ob2(k,:) = Y_ob2*oknoWys+oknoD-(i-1)*skok_y;

                                patch(X_ob(k,:),Y_ob(k,:),'b');
                                hold on
                            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%POPRAWA i dodanie K jako zmiennej wyjscia
                            end
                            elseif strcmp(fls.orMethod,'probor')
                                if IleWejsc == 1
                                    prod_dolna = probor(mf_dolna(:,1));
                                    prod_gorna = probor(mf_gorna(:,1));
                                elseif IleWejsc == 2
                                    [prod_dolna, prod_gorna] =   probor_or(n_lin1x,n_lin2x,mf_dolna(:,1),mf_gorna(:,1),mf_dolna(:,2),mf_gorna(:,2));
                                    if prod_dolna > prod_gorna
                                            temp = prod_dolna;
                                            prod_dolna = prod_gorna;
                                            prod_gorna = temp;
                                    end
                                [X_ob, Y_ob] = or_plot_bs(x, prod_dolna, prod_gorna,mf_dolna_wyj,mf_gorna_wyj);
                                elseif IleWejsc == 3
                                    ...
                                    prod_dolna = probor([prod_dolna1 prod_dolna2]);
                                    prod_gorna = probor([prod_gorna1 prod_gorna2]);
                                [X_ob, Y_ob] = or_plot_bs(x, prod_dolna, prod_gorna,mf_dolna_wyj,mf_gorna_wyj);
                                elseif IleWejsc == 4
                                     [prod_dolna1, prod_gorna1] =   probor_or(n_lin1x,n_lin2x,mf_dolna(:,1),mf_gorna(:,1),mf_dolna(:,2),mf_gorna(:,2));
                                    if prod_dolna1 > prod_gorna1
                                    ...
                                    [prod_dolna2, prod_gorna2] =   probor_or(n_lin1x,n_lin2x,mf_dolna(:,3),mf_gorna(:,3),mf_dolna(:,4),mf_gorna(:,4));
                                    if prod_dolna2 > prod_gorna2
                                            temp = prod_dolna2;
                                            prod_dolna2 = prod_gorna2;
                                            prod_gorna2 = temp;
                            ...
                            %ilosc okien * skok w pionie
                             Y_ob2(k,:) = downsample(Y_ob(k,:),8);                           
                            Y_ob2(k,:) = Y_ob2(k,:)*(oknoWys+1)+oknoD-(i-1)*skok_y;
...
%                            
                            ...
                            dlin3 = get(handles.wej3_wart,'Value');
                            dlin4 = get(handles.wej4_wart,'Value');   
             ...
             for k=1:IleWyjsc
                        ...
                        patch([krL krL krP krP], ...
                               [oknoD-skok_y*(IleReg + k-1) oknoG-skok_y*(IleReg + k-1) ...
                                oknoG-skok_y*(IleReg + k-1) oknoD-skok_y*(IleReg + k-1)],obCol);
                            ...
                            elseif strcmp(fls.aggMethod,'prod')
                                [Xagg_ob, Yagg_ob] = prod_agg(X_ob_mac(:,:,k),Y_ob_mac(:,:,k));
                            end
                               x_do_wyj = Xagg_ob;
                               y_do_wyj = Yagg_ob;
                                ...
                                Yagg_ob = Yagg_ob*(oknoWys)+oknoD-(IleReg+k-1)*skok_y;
...
%                         end
                         ...
                         odpCol = [1 1 0.5];
                         line([out(k) out(k)], [oknoD-3-skok_y*(IleReg+k-1) oknoG+1-skok_y*(IleReg+k-1)],'Color',odpCol,'LineWidth',3);
                         %tekstowo wartosc wyjscia
                         set(handles.wyj_wart,'String',num2str(out));

       
                         %dolna wartsc y linii
                         handles.lin1Yd = oknoD-oknoWys*(i+0.3);
